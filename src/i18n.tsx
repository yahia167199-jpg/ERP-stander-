...
export const translations: Translations = {
  ...
  invoices: { ar: 'قسم الفواتير', en: 'Invoices Department' },
  allInvoices: { ar: 'جميع الفواتير', en: 'All Invoices' },
  invoiceType: { ar: 'نوع الفاتورة', en: 'Invoice Type' },
  originalAmount: { ar: 'المبلغ الأصلي', en: 'Original Amount' },
  returnsAmount: { ar: 'مبلغ المرتجعات', en: 'Returns Amount' },
  netAmount: { ar: 'المبلغ الصافي', en: 'Net Amount' },
  relatedTransactions: { ar: 'المعاملات المرتبطة', en: 'Related Transactions' },
  ...
  erpSystem: { ar: 'MMK ERP', en: 'MMK ERP' },
  ...
  mainCategory: { ar: 'تصنيف رئيسي', en: 'Main Category' },
  subCategory: { ar: 'تصنيف فرعي', en: 'Sub-category' },
  parentCategory: { ar: 'التصنيف الرئيسي', en: 'Parent Category' },
  pieceType: { ar: 'نوع القطعة', en: 'Piece Type' },
  singlePiece: { ar: 'قطعة واحدة', en: 'Single Piece' },
  pairPiece: { ar: 'زوج (يمين ويسار)', en: 'Pair (Left & Right)' },
  selectPieceType: { ar: 'اختر نوع القطعة', en: 'Select Piece Type' },
  forcedReturnBoth: { ar: 'يتم استرجاع الزوج كاملاً (يمين ويسار) اجبارياً وبالسعر الذي تم البيع به', en: 'Both (Left & Right) must be returned together at the sale price' },
  ...
  scanWithCamera: { ar: 'مسح بالكاميرا', en: 'Scan with Camera' },
  pointCameraAtCode: { ar: 'وجه الكاميرا نحو الكود', en: 'Point camera at code' },
  initializingCamera: { ar: 'جاري تشغيل الكاميرا...', en: 'Initializing camera...' },
  cameraPermissionDenied: { ar: 'تم رفض صلاحية الكاميرا أو أنها غير متاحة', en: 'Camera permission denied or not available' },
  supportsQRAndBarcode: { ar: 'يدعم QR Code و Barcode', en: 'Supports QR Code and Barcode' },
  productNotFound: { ar: 'المنتج غير موجود في النظام', en: 'Product not found in the system' },
  readyToScan: { ar: 'جاهز للمسح', en: 'Ready to scan' },
  searching: { ar: 'جاري البحث...', en: 'Searching...' },
  productAdded: { ar: 'تمت إضافة المنتج', en: 'Product added' },
  externalScannerReady: { ar: 'الماسح الخارجي جاهز', en: 'External scanner ready' },
};
